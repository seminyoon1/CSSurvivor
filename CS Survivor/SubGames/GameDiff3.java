...
public class GameDiff3 {
    public static void main(String name, int health, int hunger, String sleep, 
                            int exercise, int money, String[] schedule) throws InterruptedException {    
        Mood currentMood = new NormalMood();
        Scanner intro = new Scanner(System.in);
        Hard currentGame = new Hard(0, health, hunger, sleep, exercise, money, schedule);
        ...
        while(currentGame.getDay() <= 29) {
            ...
            for(int i = 0; i < 24; i++) {
                ...
                System.out.println("What will you do? Study/Eat/Sleep/Class/Play/Exercise/Work/X ");
                ...
                if(response.equals("Study")) {
                    ...
                    currentMood = currentMood.decreaseMood();
                    currentGame.decreaseHealth(7);
                    currentGame.decreaseHunger(7);
        ...
        if(passedAll == true) {
            ...
            System.out.println("You have failed at least 1 class and could not graduate... Try Again?");
        }
        intro.close();
    }
}